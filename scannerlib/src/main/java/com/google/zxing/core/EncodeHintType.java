...
public enum EncodeHintType {
   ...
   * {@link com.google.zxing.core.qrcode.decoder.ErrorCorrectionLevel ErrorCorrectionLevel}.
  ...
  /**
   * Specifies the matrix shape for Data Matrix (type {@link com.google.zxing.core.datamatrix.encoder.SymbolShapeHint})
   */
  DATA_MATRIX_SHAPE,
   ...
   * {@link com.google.zxing.core.datamatrix.DataMatrixWriter#encode(String, BarcodeFormat, int, int)}
   */
  @Deprecated
  MIN_SIZE,
   ...
   * {@link com.google.zxing.core.pdf417.encoder.Compaction Compaction} or {@link String} value of one of its
   * enum values).
   */
  PDF417_COMPACTION,
   ...
   * {@link com.google.zxing.core.pdf417.encoder.Dimensions Dimensions}).
   */
  PDF417_DIMENSIONS,
