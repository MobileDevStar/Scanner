...
package com.itdevstar.scannerlib.share;
...
import com.itdevstar.scannerlib.encode.EncodeActivity;
...
public final class ShareActivity extends Activity {
  ...
  private Intent buildEncodeIntent(String type) {
    Intent  intent = new Intent(Intents.Encode.ACTION, null, getApplicationContext(), EncodeActivity.class);
//    intent.setAction(Intents.Encode.ACTION);
  ...
  private static Intent buildEncodeIntent(String type) {
    ...
    intent.setPackage("com.itdevstar.scannerlib");
    intent.addFlags(Intents.FLAG_NEW_DOC);
    intent.putExtra(Intents.Encode.TYPE, type);
    intent.putExtra(Intents.Encode.FORMAT, BarcodeFormat.QR_CODE.toString());
    return intent;
